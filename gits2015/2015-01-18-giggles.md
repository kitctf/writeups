...
[source code](https://github.com/kitctf/writeups/blob/master/gits2015/giggles/server.c)
...
We note that `2` is supposed to be the number of function parameters. This is
however wrong, actually `3` arguments are provided when the function is called
later. In fact the provded value here is totally ignored by the server.
